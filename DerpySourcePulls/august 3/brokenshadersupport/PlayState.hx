...
class PlayState extends MusicBeatState
{
	...
	//Jotu's Character Selection Shit 
	...
	override public function create()
	{
		...
		case 2:
		boyfriend = new Boyfriend(0, 0, 'gf');
		case 3:
		boyfriend = new Boyfriend(0, 0, 'sonicLord');
		case 4:
		boyfriend = new Boyfriend(0, 0, 'fakerbf');
		case 5:
		boyfriend = new Boyfriend(0, 0, 'christmasbf');
		case 6:
		boyfriend = new Boyfriend(0, 0, 'sonic');
		}
